...
const UsersTags = () => (
  <>
    ...
    >
      ...
      <Span>{t('__EXPRESS_4_WIZARD_STEP_WHO_TAG_USERS_LANGUAGE')}</Span>
    </StyledTag>
  </>
);
...
export const WhoStep = ({
  ...
  return (
    <ContainerCard>
      ...
      <StyledFormField>
        <Label>
          {t('__EXPRESS_4_WIZARD_STEP_WHO_FIELD_AGE_RANGE_LABEL')}
        ...
        <Row>
          <WizardCol>
            <StyledRadioField>
              ...
              >
                <Label isRegular>
                  {t('__EXPRESS_4_WIZARD_STEP_WHO_FIELD_AGE_RANGE_ALL')}
                </Label>
                <Hint>
      ...
      <StyledFormField>
        <Label>
          {t('__EXPRESS_4_WIZARD_STEP_WHO_FIELD_GENDER_LABEL')}
          <Span style={{ color: globalTheme.colors.dangerHue }}>*</Span>
        </Label>
        <Row>
          <WizardCol>
            <StyledRadioField>
              ...
              >
                <Label isRegular>
                  {t('__EXPRESS_4_WIZARD_STEP_WHO_FIELD_GENDER_ALL')}
                </Label>
                <Hint>
      ...
      <StyledFormField>
        <Label>
          {t('__EXPRESS_4_WIZARD_STEP_WHO_FIELD_LITERACY_LABEL')}
          <Span style={{ color: globalTheme.colors.dangerHue }}>*</Span>
        </Label>
        <Row>
          <WizardCol>
            <StyledRadioField>
              ...
              >
                <Label isRegular>
                  {t('__EXPRESS_4_WIZARD_STEP_WHO_FIELD_LITERACY_ALL')}
                </Label>
                <Hint>
