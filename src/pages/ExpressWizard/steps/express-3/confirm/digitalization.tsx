...
export const Digitalization = (props: FormikProps<WizardModel>) => {
  ...
  switch (digitalLiteracy) {
    case 'expert':
      return (
        <Trans i18nKey="__EXPRESS_3_WIZARD_STEP_RECAP_WHO_DIGITALIZATION_TEXT_EXPERT">
    ...
    case 'intermediate':
      return (
        <Trans i18nKey="__EXPRESS_3_WIZARD_STEP_RECAP_WHO_DIGITALIZATION_TEXT_INTERMEDIATE">
    ...
    case 'beginner':
      return (
        <Trans i18nKey="__EXPRESS_3_WIZARD_STEP_RECAP_WHO_DIGITALIZATION_TEXT_BEGINNER">
    ...
    default:
      return (
        <Trans i18nKey="__EXPRESS_3_WIZARD_STEP_RECAP_WHO_DIGITALIZATION_TEXT_ALL">
