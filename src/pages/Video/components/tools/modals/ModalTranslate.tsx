...
export const ModalTranslate = () => {
  ...
  return (
    <Modal onClose={onClose}>
      <Modal.Header>{t('__TOOLS_MODAL_TRANSLATE_HEADER')}</Modal.Header>
      <Modal.Body>{t('__TOOLS_MODAL_TRANSLATE_BODY')}</Modal.Body>
      <Modal.Footer>
        <Button isLink onClick={onClose}>
          {t('__TOOLS_MODAL_TRANSLATE_CLOSE_BUTTON')}
        </Button>
        <Button isPrimary isAccent onClick={() => {}}>
          {t('__TOOLS_MODAL_TRANSLATE_SEND_BUTTON')}
        </Button>
      </Modal.Footer>
