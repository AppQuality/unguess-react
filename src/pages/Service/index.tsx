...
import { Anchor, Breadcrumb, Button, Col, Grid, LG, Paragraph, Row, Span, Tag, theme, XXL } from "@appquality/unguess-design-system";
...
export default function Service() {
    ...
    return (
        <Page title={serviceName} route={"templates"}>
            {error ? (
                <pre>
                ...
                <>
                    <Grid>
                        <Row>
                            <Col xs={12} lg={6}>
                                <Breadcrumb>
                                    <Anchor onClick={() => navigate(homeRoute, { replace: true })}>{t("__BREADCRUMB_ITEM_DASHBOARD")}</Anchor>
                                    <Anchor onClick={() => navigate(servicesRoute, { replace: true })}>{t("__BREADCRUMB_ITEM_SERVICES")}</Anchor>
                                ...
                                <TagsContainer>
                                    {isExpress ? (
                                        ...
                                        >
                                            <Tag.Avatar><ExpressIcon /></Tag.Avatar>
                                        ...
                                        <Tag
                                            ...
                                            hue={theme.palette.grey[100]}
                                        >
                                            <Tag.Avatar><TailoredIcon /></Tag.Avatar>
                                    ...
                                    {isFunctional ? (
                                        <Tag
                                            ...
                                            hue={theme.palette.grey[100]}
                                        >
                                            <Tag.Avatar><FunctionalIcon /></Tag.Avatar>
                                        ...
                                        <Tag
                                            ...
                                            hue={theme.palette.grey[100]}
                                        >
                                            <Tag.Avatar><ExperientialIcon /></Tag.Avatar>
