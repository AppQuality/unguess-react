import { Card, Col, Divider, Grid, MD, OrderedList, Paragraph, Row, Timeline, XXL } from "@appquality/unguess-design-system";
                ...
                <Row>
                    ...
                    <Col xs={12} lg={6}>
                        <TimelineCard id={"why-card"} className={"why-card"}>
                            <StepTitle>{t("__CATALOG_DETAIL_STICKY_CONTAINER_ABOUT_WHY_ITEM")}</StepTitle>
                        ...
                        <TimelineCard id={"what-card"} className={"what-card"}>
                            <StepTitle>{t("__CATALOG_DETAIL_STICKY_CONTAINER_ABOUT_WHAT_ITEM")}</StepTitle>
                        ...
                        <TimelineCard id={"how-card"} className={"how-card"}>
                            <StepTitle>{t("__CATALOG_DETAIL_STICKY_CONTAINER_ABOUT_HOW_ITEM")}</StepTitle>
