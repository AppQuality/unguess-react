      ...
      <Col>
        <CenteredXYContainer>
          ...
          <Paragraph style={{textAlign: "center"}}>
            <LG style={{color: theme.palette.blue[600]}}>{t("__DASHBOARD_EMPTY_SEARCH_RESULTS_TITLE")}</LG>
            <MD style={{color: theme.palette.grey[500]}}>{t("__DASHBOARD_EMPTY_SEARCH_RESULTS_DESCRIPTION")}</MD>
          </Paragraph>
